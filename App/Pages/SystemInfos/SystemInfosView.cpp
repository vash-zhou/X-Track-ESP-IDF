...
{
    char msg[128] = {'\0'};
    snprintf(msg, sizeof(msg), "%.2fkm\n%s\n%.1fkm/h", trip, time, maxSpd);
    lv_label_set_text_fmt(ui.sport.labelData, "%s", msg);
}
...
{
    char msg[128] = {'\0'};
    snprintf(msg, sizeof(msg), "%d%%\n%.2fV\n%s", usage, voltage, state);
    lv_label_set_text_fmt(ui.battery.labelData, "%s", msg);
}
